...
var coyote = function (){
	...
	$('#fullpage1').fullpage({
		menu: '#menu',
		scrollBar:true,
		anchors: ['abot_sec', 'networking', 'networking1', 'networking2', 'membership','advisory','partners','contact_sec'],
		navigation: true,
		navigationPosition: 'right',
		navigationTooltips: ['about', 'networking', 'membership','Advisory','partners','contact'],
		responsiveWidth: 3000
	});
	/*Fullpage JS*/
	$('#fullpage2').fullpage({
